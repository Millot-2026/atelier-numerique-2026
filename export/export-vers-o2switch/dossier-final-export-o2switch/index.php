...
<body>
    ...
    <div class="news-sheet">
        ...
        <div class="news-footer">
            ...
            <span>•</span>
            <span>Mise à jour : 06/08/2026 à 12:54</span>
        </div>
    ...
    <details class="section-block">
        ...
        <div class="section-body">
            <div class="grid">
                             ...
                             data-summary="Cockpit central et tableau de bord de l&#039;atelier nomade."
                             data-img="images/images-workstation/01-header.png"
                             data-details='{&quot;niveau1&quot;:{&quot;pitch&quot;:&quot;V\u00e9ritable cockpit central et tableau de bord ultime, &lt;strong&gt;Workstation&lt;\/strong&gt; unifie le pilotage du temps, la m\u00e9t\u00e9o en direct et les outils de prototypage.&quot;,&quot;technos&quot;:[&quot;PHP&quot;,&quot;JavaScript&quot;,&quot;CSS Custom&quot;],&quot;image&quot;:&quot;01-header.png&quot;}}'>
                            <div>
                                <div class="card-title">workstation</div>
                                <span class="badge badge-operational" 
                                      data-project="workstation"
                                      data-status="operational"
                                      onclick="cycleStatus(this)" title="Cliquez pour changer le statut">
                                    &#x1F7E0; Op&eacute;rationnel                                </span>
                            </div>
                            <div class="card-actions">
                                <a class="card-link" href="/workstation/" target="_blank">Lancer le site</a>
                                <button type="button" class="btn-info" onclick="openOverlay(this)"><i class="fas fa-eye"></i> En savoir plus...</button>
                            </div>
                        </div>
                                                                    <div class="card" 
                             data-title="modulor"
                             data-summary="Description détaillée et présentation complète du projet web : modulor."
                             data-img="images/dashboard/photo-640x480.png"
                             data-details='null'>
                            <div>
                                <div class="card-title">modulor</div>
                                <span class="badge badge-operational" 
                                      data-project="modulor"
                                      data-status="operational"
                                      onclick="cycleStatus(this)" title="Cliquez pour changer le statut">
                                    &#x1F7E0; Op&eacute;rationnel                                </span>
                            </div>
                            <div class="card-actions">
                                <a class="card-link" href="/modulor/" target="_blank">Lancer le site</a>
                                <button type="button" class="btn-info" onclick="openOverlay(this)"><i class="fas fa-eye"></i> En savoir plus...</button>
                            </div>
                        </div>
                                                                    <div class="card" 
                             data-title="skeletor-v1.0"
                             data-summary="Description détaillée et présentation complète du projet web : skeletor-v1.0."
                             data-img="images/dashboard/photo-640x480.png"
                             data-details='null'>
                            <div>
                                <div class="card-title">skeletor-v1.0</div>
                                <span class="badge badge-operational" 
                                      data-project="skeletor-v1.0"
                                      data-status="operational"
                                      onclick="cycleStatus(this)" title="Cliquez pour changer le statut">
                                    &#x1F7E0; Op&eacute;rationnel                                </span>
                            </div>
                            <div class="card-actions">
                                <a class="card-link" href="/skeletor-v1.0/" target="_blank">Lancer le site</a>
                                <button type="button" class="btn-info" onclick="openOverlay(this)"><i class="fas fa-eye"></i> En savoir plus...</button>
                            </div>
                        </div>
                                                                    <div class="card" 
                             data-title="skeletor-v1.0-o2switch"
                             data-summary="Description détaillée et présentation complète du projet web : skeletor-v1.0-o2switch."
                             data-img="images/dashboard/photo-640x480.png"
                             data-details='null'>
                            <div>
                                <div class="card-title">skeletor-v1.0-o2switch</div>
                                <span class="badge badge-operational" 
                                      data-project="skeletor-v1.0-o2switch"
                                      data-status="operational"
                                      onclick="cycleStatus(this)" title="Cliquez pour changer le statut">
                                    &#x1F7E0; Op&eacute;rationnel                                </span>
                            </div>
                            <div class="card-actions">
                                <a class="card-link" href="/skeletor-v1.0-o2switch/" target="_blank">Lancer le site</a>
                                <button type="button" class="btn-info" onclick="openOverlay(this)"><i class="fas fa-eye"></i> En savoir plus...</button>
                            </div>
                        </div>
                                                                    <div class="card" 
                             data-title="personator-v1.2"
                             data-summary="Description détaillée et présentation complète du projet web : personator-v1.2."
                             data-img="images/dashboard/photo-640x480.png"
                             data-details='null'>
                            <div>
                                <div class="card-title">personator-v1.2</div>
                                <span class="badge badge-operational" 
                                      data-project="personator-v1.2"
                                      data-status="operational"
                                      onclick="cycleStatus(this)" title="Cliquez pour changer le statut">
                                    &#x1F7E0; Op&eacute;rationnel                                </span>
                            </div>
                            <div class="card-actions">
                                <a class="card-link" href="/personator-v1.2/" target="_blank">Lancer le site</a>
                                <button type="button" class="btn-info" onclick="openOverlay(this)"><i class="fas fa-eye"></i> En savoir plus...</button>
                            </div>
                        </div>
                                                                    <div class="card" 
                             data-title="cms-2026-v8-full"
                             data-summary="Description détaillée et présentation complète du projet web : cms-2026-v8-full."
                             data-img="images/images-cms/photo-640x480.png"
                             data-details='null'>
                            <div>
                                <div class="card-title">cms-2026-v8-full</div>
                                <span class="badge badge-operational" 
                                      data-project="cms-2026-v8-full"
                                      data-status="operational"
                                      onclick="cycleStatus(this)" title="Cliquez pour changer le statut">
                                    &#x1F7E0; Op&eacute;rationnel                                </span>
                            </div>
                            <div class="card-actions">
                                <a class="card-link" href="/cms-2026-v8-full/" target="_blank">Lancer le site</a>
                                <button type="button" class="btn-info" onclick="openOverlay(this)"><i class="fas fa-eye"></i> En savoir plus...</button>
                            </div>
                        </div>
                                                                    <div class="card" 
                             data-title="texturor"
                             data-summary="Description détaillée et présentation complète du projet web : texturor."
                             data-img="images/dashboard/photo-640x480.png"
                             data-details='null'>
                            <div>
                                <div class="card-title">texturor</div>
                                <span class="badge badge-operational" 
                                      data-project="texturor"
                                      data-status="operational"
                                      onclick="cycleStatus(this)" title="Cliquez pour changer le statut">
                                    &#x1F7E0; Op&eacute;rationnel                                </span>
                            </div>
                            <div class="card-actions">
                                <a class="card-link" href="/texturor/" target="_blank">Lancer le site</a>
                                <button type="button" class="btn-info" onclick="openOverlay(this)"><i class="fas fa-eye"></i> En savoir plus...</button>
                            </div>
                        </div>
                                                                    <div class="card" 
                             data-title="user_journey-v1.0"
                             data-summary="Description détaillée et présentation complète du projet web : user_journey-v1.0."
                             data-img="images/dashboard/photo-640x480.png"
                             data-details='{&quot;niveau1&quot;:{&quot;pitch&quot;:&quot;Pens\u00e9 pour fa\u00e7onner et orchestrer les parcours utilisateurs, &lt;strong&gt;user_journey-v1.0&lt;\/strong&gt; est le seul outil de cette cl\u00e9 enti\u00e8rement con\u00e7u pour l&#039;UX-UI pure.&quot;,&quot;technos&quot;:[&quot;UI Design&quot;,&quot;UX Research&quot;,&quot;Prototypage&quot;],&quot;image&quot;:&quot;photo-640x480.png&quot;}}'>
                            <div>
                                <div class="card-title">user_journey-v1.0</div>
                                <span class="badge badge-operational" 
                                      data-project="user_journey-v1.0"
                                      data-status="operational"
                                      onclick="cycleStatus(this)" title="Cliquez pour changer le statut">
                                    &#x1F7E0; Op&eacute;rationnel                                </span>
                            </div>
                            <div class="card-actions">
                                <a class="card-link" href="/user_journey-v1.0/" target="_blank">Lancer le site</a>
                                <button type="button" class="btn-info" onclick="openOverlay(this)"><i class="fas fa-eye"></i> En savoir plus...</button>
                            </div>
                        </div>
                                                                    <div class="card" 
                             data-title="wordpress-portable"
                             data-summary="Description détaillée et présentation complète du projet web : wordpress-portable."
                             data-img="images/dashboard/photo-640x480.png"
                             data-details='null'>
                            <div>
                                <div class="card-title">wordpress-portable</div>
                                <span class="badge badge-wp" 
                                      data-project="wordpress-portable"
                                      data-status="operational"
                                      >
                                    &#x2699;&#xFE0F; WordPress                                </span>
                            </div>
                            <div class="card-actions">
                                <a class="card-link" href="/wordpress-portable/" target="_blank">Lancer le site</a>
                                <button type="button" class="btn-info" onclick="openOverlay(this)"><i class="fas fa-eye"></i> En savoir plus...</button>
                            </div>
                        </div>
                                                                    <div class="card" 
                             data-title="mon-site"
                             data-summary="Description détaillée et présentation complète du projet web : mon-site."
                             data-img="images/dashboard/photo-640x480.png"
                             data-details='null'>
                            <div>
                                <div class="card-title">mon-site</div>
                                <span class="badge badge-operational" 
                                      data-project="mon-site"
                                      data-status="operational"
                                      onclick="cycleStatus(this)" title="Cliquez pour changer le statut">
                                    &#x1F7E0; Op&eacute;rationnel                                </span>
                            </div>
                            <div class="card-actions">
                                <a class="card-link" href="/mon-site/" target="_blank">Lancer le site</a>
                                <button type="button" class="btn-info" onclick="openOverlay(this)"><i class="fas fa-eye"></i> En savoir plus...</button>
                            </div>
                        </div>
                                                                    <div class="card" 
                             data-title="Projet-demo-pour-site-en-ligne"
                             data-summary="Description détaillée et présentation complète du projet web : Projet-demo-pour-site-en-ligne."
                             data-img="images/dashboard/photo-640x480.png"
                             data-details='null'>
                            <div>
                                <div class="card-title">Projet-demo-pour-site-en-ligne</div>
                                <span class="badge badge-operational" 
                                      data-project="Projet-demo-pour-site-en-ligne"
                                      data-status="operational"
                                      onclick="cycleStatus(this)" title="Cliquez pour changer le statut">
                                    &#x1F7E0; Op&eacute;rationnel                                </span>
                            </div>
                            <div class="card-actions">
                                <a class="card-link" href="/Projet-demo-pour-site-en-ligne/" target="_blank">Lancer le site</a>
                                <button type="button" class="btn-info" onclick="openOverlay(this)"><i class="fas fa-eye"></i> En savoir plus...</button>
                            </div>
                        </div>
                                                </div>
    ...
    <div class="projects-grid-v2">
            ...
            <div class="card-v2 card"
                ...
                <div class="card-v2-top">
                    <h3 class="card-v2-title">workstation</h3>
                </div>

                <!-- 2. Bloc Média (Aperçu visuel / Image) -->
                <div class="card-v2-media">
                    <img src="images/dashboard/photo-640x480.png" alt="workstation">
                </div>
                    ...
                    <div>
                        ...
                        <!-- Affichage conditionnel des badges technos -->
                                                    <div class="card-v2-technos">
                                                                    ...
                                                                    <span class="badge-tech">CSS Custom</span>
                                                            </div>
                                            </div>

                    <!-- 4. Boutons d'action verticalisés (Lancer + En savoir plus) -->
                    <div class="card-v2-actions">
                        <a class="btn-v2-primary" href="/workstation/" target="_blank">
                            Lancer le site
                        </a>
            ...
            <div class="card-v2 card"
                ...
                <!-- 1. Titre seul au-dessus de l'image -->
                <div class="card-v2-top">
                    <h3 class="card-v2-title">modulor</h3>
                </div>

                <!-- 2. Bloc Média (Aperçu visuel / Image) -->
                <div class="card-v2-media">
                    <img src="images/dashboard/photo-640x480.png" alt="modulor">
                </div>
                ...
                <div class="card-v2-body">
                    ...
                    <!-- 4. Boutons d'action verticalisés (Lancer + En savoir plus) -->
                    <div class="card-v2-actions">
                        <a class="btn-v2-primary" href="/modulor/" target="_blank">
                            Lancer le site
                        </a>
                        <button type="button" class="btn-v2-ghost" onclick="openOverlay(this)" title="En savoir plus">
                            <i class="fas fa-eye"></i> En savoir plus...
            ...
            <div class="card-v2 card"
                ...
                <!-- 1. Titre seul au-dessus de l'image -->
                <div class="card-v2-top">
                    <h3 class="card-v2-title">skeletor-v1.0</h3>
                </div>

                <!-- 2. Bloc Média (Aperçu visuel / Image) -->
                <div class="card-v2-media">
                    <img src="images/dashboard/photo-640x480.png" alt="skeletor-v1.0">
                </div>
                ...
                <div class="card-v2-body">
                    ...
                    <!-- 4. Boutons d'action verticalisés (Lancer + En savoir plus) -->
                    <div class="card-v2-actions">
                        <a class="btn-v2-primary" href="/skeletor-v1.0/" target="_blank">
                            Lancer le site
                        </a>
                        <button type="button" class="btn-v2-ghost" onclick="openOverlay(this)" title="En savoir plus">
                            <i class="fas fa-eye"></i> En savoir plus...
            ...
            <div class="card-v2 card"
                ...
                <!-- 1. Titre seul au-dessus de l'image -->
                <div class="card-v2-top">
                    <h3 class="card-v2-title">skeletor-v1.0-o2switch</h3>
                </div>

                <!-- 2. Bloc Média (Aperçu visuel / Image) -->
                <div class="card-v2-media">
                    <img src="images/dashboard/photo-640x480.png" alt="skeletor-v1.0-o2switch">
                </div>
                ...
                <div class="card-v2-body">
                    ...
                    <!-- 4. Boutons d'action verticalisés (Lancer + En savoir plus) -->
                    <div class="card-v2-actions">
                        <a class="btn-v2-primary" href="/skeletor-v1.0-o2switch/" target="_blank">
                            Lancer le site
                        </a>
                        <button type="button" class="btn-v2-ghost" onclick="openOverlay(this)" title="En savoir plus">
                            <i class="fas fa-eye"></i> En savoir plus...
            ...
            <div class="card-v2 card"
                ...
                <!-- 1. Titre seul au-dessus de l'image -->
                <div class="card-v2-top">
                    <h3 class="card-v2-title">personator-v1.2</h3>
                </div>

                <!-- 2. Bloc Média (Aperçu visuel / Image) -->
                <div class="card-v2-media">
                    <img src="images/dashboard/photo-640x480.png" alt="personator-v1.2">
                </div>
                ...
                <div class="card-v2-body">
                    ...
                    <!-- 4. Boutons d'action verticalisés (Lancer + En savoir plus) -->
                    <div class="card-v2-actions">
                        <a class="btn-v2-primary" href="/personator-v1.2/" target="_blank">
                            Lancer le site
                        </a>
                        <button type="button" class="btn-v2-ghost" onclick="openOverlay(this)" title="En savoir plus">
                            <i class="fas fa-eye"></i> En savoir plus...
            ...
            <div class="card-v2 card"
                ...
                <!-- 1. Titre seul au-dessus de l'image -->
                <div class="card-v2-top">
                    <h3 class="card-v2-title">cms-2026-v8-full</h3>
                </div>

                <!-- 2. Bloc Média (Aperçu visuel / Image) -->
                <div class="card-v2-media">
                    <img src="images/dashboard/photo-640x480.png" alt="cms-2026-v8-full">
                </div>
                ...
                <div class="card-v2-body">
                    ...
                    <!-- 4. Boutons d'action verticalisés (Lancer + En savoir plus) -->
                    <div class="card-v2-actions">
                        <a class="btn-v2-primary" href="/cms-2026-v8-full/" target="_blank">
                            Lancer le site
                        </a>
                        <button type="button" class="btn-v2-ghost" onclick="openOverlay(this)" title="En savoir plus">
                            <i class="fas fa-eye"></i> En savoir plus...
            ...
            <div class="card-v2 card"
                ...
                <!-- 1. Titre seul au-dessus de l'image -->
                <div class="card-v2-top">
                    <h3 class="card-v2-title">texturor</h3>
                </div>
                ...
                <div class="card-v2-body">
                    ...
                    <!-- 4. Boutons d'action verticalisés (Lancer + En savoir plus) -->
                    <div class="card-v2-actions">
                        <a class="btn-v2-primary" href="/texturor/" target="_blank">
                            Lancer le site
                        </a>
                        <button type="button" class="btn-v2-ghost" onclick="openOverlay(this)" title="En savoir plus">
                            <i class="fas fa-eye"></i> En savoir plus...
            ...
            <div class="card-v2 card"
                ...
                <!-- 1. Titre seul au-dessus de l'image -->
                <div class="card-v2-top">
                    <h3 class="card-v2-title">user_journey-v1.0</h3>
                </div>
                ...
                <div class="card-v2-body">
                    <div>
                        ...
                        <!-- Affichage conditionnel des badges technos -->
                                                    <div class="card-v2-technos">
                                                                    <span class="badge-tech">UI Design</span>
                                                                    <span class="badge-tech">UX Research</span>
                                                                    <span class="badge-tech">Prototypage</span>
                                                            </div>
                                            </div>

                    <!-- 4. Boutons d'action verticalisés (Lancer + En savoir plus) -->
                    <div class="card-v2-actions">
                        <a class="btn-v2-primary" href="/user_journey-v1.0/" target="_blank">
                            Lancer le site
                        </a>
                        <button type="button" class="btn-v2-ghost" onclick="openOverlay(this)" title="En savoir plus">
                            <i class="fas fa-eye"></i> En savoir plus...
            ...
            <div class="card-v2 card"
                ...
                <!-- 1. Titre seul au-dessus de l'image -->
                <div class="card-v2-top">
                    <h3 class="card-v2-title">wordpress-portable</h3>
                </div>
                ...
                <div class="card-v2-body">
                    ...
                    <!-- 4. Boutons d'action verticalisés (Lancer + En savoir plus) -->
                    <div class="card-v2-actions">
                        <a class="btn-v2-primary" href="/wordpress-portable/" target="_blank">
                            Lancer le site
                        </a>
                        <button type="button" class="btn-v2-ghost" onclick="openOverlay(this)" title="En savoir plus">
                            <i class="fas fa-eye"></i> En savoir plus...
            ...
            <div class="card-v2 card"
                ...
                <!-- 1. Titre seul au-dessus de l'image -->
                <div class="card-v2-top">
                    <h3 class="card-v2-title">mon-site</h3>
                </div>
                ...
                <div class="card-v2-body">
                    ...
                    <!-- 4. Boutons d'action verticalisés (Lancer + En savoir plus) -->
                    <div class="card-v2-actions">
                        <a class="btn-v2-primary" href="/mon-site/" target="_blank">
                            Lancer le site
                        </a>
                        <button type="button" class="btn-v2-ghost" onclick="openOverlay(this)" title="En savoir plus">
                            <i class="fas fa-eye"></i> En savoir plus...
            ...
            <div class="card-v2 card"
                ...
                <!-- 1. Titre seul au-dessus de l'image -->
                <div class="card-v2-top">
                    <h3 class="card-v2-title">Projet-demo-pour-site-en-ligne</h3>
                </div>
                ...
                <div class="card-v2-body">
                    ...
                    <!-- 4. Boutons d'action verticalisés (Lancer + En savoir plus) -->
                    <div class="card-v2-actions">
                        <a class="btn-v2-primary" href="/Projet-demo-pour-site-en-ligne/" target="_blank">
                            Lancer le site
                        </a>
                        <button type="button" class="btn-v2-ghost" onclick="openOverlay(this)" title="En savoir plus">
                            <i class="fas fa-eye"></i> En savoir plus...
    ...
    <details class="section-block" open>
        ...
        <div class="section-body">
            <div class="grid" id="exports-grid">
                <div class="card" id="export-card-bio-christophe-millot"><button type="button" class="btn-delete-export" onclick="deleteExport('bio-christophe-millot')" title="Supprimer définitivement ce dossier">×</button><div><div style="margin-bottom: 8px;"><span style="display:inline-block;font-size:0.65rem;font-weight:700;letter-spacing:0.5px;padding:3px 8px;border-radius:99px;text-transform:uppercase;background:rgba(245, 158, 11, 0.15);color:var(--orange);">export-personnator</span></div><div class="card-title" style="font-size:1rem;word-break:break-all;">bio-christophe-millot</div></div><div class="card-actions" style="margin-top:15px;"><a class="card-link" href="export/bio-christophe-millot/index.html" target="_blank">Voir le persona</a></div></div><div class="card" id="export-card-export-vers-o2switch"><button type="button" class="btn-delete-export" onclick="deleteExport('export-vers-o2switch')" title="Supprimer définitivement ce dossier">×</button><div><div style="margin-bottom: 8px;"><span style="display:inline-block;font-size:0.65rem;font-weight:700;letter-spacing:0.5px;padding:3px 8px;border-radius:99px;text-transform:uppercase;background:rgba(155, 89, 182, 0.15);color:#bb8fce;">export-skeletor</span></div><div class="card-title" style="font-size:1rem;word-break:break-all;">export-vers-o2switch</div></div><div class="card-actions" style="margin-top:15px;"><a class="card-link" href="export/export-vers-o2switch/" target="_blank">Voir le site</a><span style="display:block;margin-top:6px;color:var(--text-muted);font-size:0.78em;">⚠️ Pas d'index détecté</span></div></div>            </div>
        </div>
    </details>
    ...
    <aside id="control-panel" role="complementary" aria-label="Control Panel — Visibilité des projets">
        ...
        <div class="cp-presets-section">
            ...
            <div class="cp-presets-grid" id="cp-presets-grid">
                                                        <button type="button" class="cp-preset-box active-preset" data-preset-num="1" title="Preset 1. Clic simple pour charger, Shift + Clic pour enregistrer/écraser, Ctrl + Clic pour supprimer.">
                        1                    </button>
                                                        <button type="button" class="cp-preset-box" data-preset-num="2" title="Preset 2. Clic simple pour charger, Shift + Clic pour enregistrer/écraser, Ctrl + Clic pour supprimer.">
                        2                    </button>
                                                        <button type="button" class="cp-preset-box" data-preset-num="3" title="Preset 3. Clic simple pour charger, Shift + Clic pour enregistrer/écraser, Ctrl + Clic pour supprimer.">
                        3                    </button>
                                                        <button type="button" class="cp-preset-box" data-preset-num="4" title="Preset 4. Clic simple pour charger, Shift + Clic pour enregistrer/écraser, Ctrl + Clic pour supprimer.">
                        4                    </button>
                                                        <button type="button" class="cp-preset-box" data-preset-num="5" title="Preset 5. Clic simple pour charger, Shift + Clic pour enregistrer/écraser, Ctrl + Clic pour supprimer.">
                        5                    </button>
                            </div>
        ...
        <div class="cp-body" id="cp-body">
            <div class="cp-section-label">Projets du Journal</div>
                        <div class="cp-project-row" data-cp-row="workstation">
                <label class="cp-toggle" title="Afficher / masquer Workstation">
                    <input
                        type="checkbox"
                        class="cp-checkbox"
                        data-project="workstation"
                        checked
                        onchange="cpToggleProject('workstation', this.closest('.cp-project-row'))"
                    >
                    <span class="cp-toggle-slider"></span>
                </label>
                <span class="cp-project-name" id="cp-label-workstation" onclick="cpToggleProject('workstation', this.closest('.cp-project-row'))">
                    Workstation                </span>
                <select class="cp-size-select" data-project-size="workstation" title="Choisir le nombre de colonnes">
                                            ...
                                            <option value="12" selected>12 col</option>
                                    </select>
                <div class="cp-move-group">
                    <button type="button" class="cp-move-btn" onclick="cpMoveProject('workstation', -1)" title="Monter l'article">▲</button>
                    <button type="button" class="cp-move-btn" onclick="cpMoveProject('workstation', 1)" title="Descendre l'article">▼</button>
                </div>
            </div>
                        <div class="cp-project-row" data-cp-row="modulor">
                <label class="cp-toggle" title="Afficher / masquer modulor">
                    <input
                        type="checkbox"
                        class="cp-checkbox"
                        data-project="modulor"
                        checked
                        onchange="cpToggleProject('modulor', this.closest('.cp-project-row'))"
                    >
                    <span class="cp-toggle-slider"></span>
                </label>
                <span class="cp-project-name" id="cp-label-modulor" onclick="cpToggleProject('modulor', this.closest('.cp-project-row'))">
                    modulor                </span>
                <select class="cp-size-select" data-project-size="modulor" title="Choisir le nombre de colonnes">
                                            <option value="4" >4 col</option>
                                            <option value="5" >5 col</option>
                                            <option value="6" >6 col</option>
                                            <option value="7" >7 col</option>
                ...
                <div class="cp-move-group">
                    <button type="button" class="cp-move-btn" onclick="cpMoveProject('modulor', -1)" title="Monter l'article">▲</button>
                    <button type="button" class="cp-move-btn" onclick="cpMoveProject('modulor', 1)" title="Descendre l'article">▼</button>
                </div>
            </div>
                        <div class="cp-project-row" data-cp-row="skeletor-v1.0">
                <label class="cp-toggle" title="Afficher / masquer skeletor-v1.0">
                    <input
                        type="checkbox"
                        class="cp-checkbox"
                        data-project="skeletor-v1.0"
                        checked
                        onchange="cpToggleProject('skeletor-v1.0', this.closest('.cp-project-row'))"
                    >
                    <span class="cp-toggle-slider"></span>
                </label>
                <span class="cp-project-name" id="cp-label-skeletor-v1.0" onclick="cpToggleProject('skeletor-v1.0', this.closest('.cp-project-row'))">
                    skeletor-v1.0                </span>
                <select class="cp-size-select" data-project-size="skeletor-v1.0" title="Choisir le nombre de colonnes">
                                            <option value="4" >4 col</option>
                                            <option value="5" >5 col</option>
                ...
                <div class="cp-move-group">
                    <button type="button" class="cp-move-btn" onclick="cpMoveProject('skeletor-v1.0', -1)" title="Monter l'article">▲</button>
                    <button type="button" class="cp-move-btn" onclick="cpMoveProject('skeletor-v1.0', 1)" title="Descendre l'article">▼</button>
                </div>
            </div>
                        <div class="cp-project-row" data-cp-row="skeletor-v1.0-o2switch">
                <label class="cp-toggle" title="Afficher / masquer skeletor-v1.0-o2switch">
                    <input
                        type="checkbox"
                        class="cp-checkbox"
                        data-project="skeletor-v1.0-o2switch"
                        checked
                        onchange="cpToggleProject('skeletor-v1.0-o2switch', this.closest('.cp-project-row'))"
                    >
                    <span class="cp-toggle-slider"></span>
                </label>
                <span class="cp-project-name" id="cp-label-skeletor-v1.0-o2switch" onclick="cpToggleProject('skeletor-v1.0-o2switch', this.closest('.cp-project-row'))">
                    skeletor-v1.0-o2switch                </span>
                <select class="cp-size-select" data-project-size="skeletor-v1.0-o2switch" title="Choisir le nombre de colonnes">
                                            <option value="4" >4 col</option>
                                            <option value="5" >5 col</option>
                                            <option value="6" selected>6 col</option>
                                            <option value="7" >7 col</option>
                ...
                <div class="cp-move-group">
                    <button type="button" class="cp-move-btn" onclick="cpMoveProject('skeletor-v1.0-o2switch', -1)" title="Monter l'article">▲</button>
                    <button type="button" class="cp-move-btn" onclick="cpMoveProject('skeletor-v1.0-o2switch', 1)" title="Descendre l'article">▼</button>
                </div>
            </div>
                        <div class="cp-project-row" data-cp-row="personator-v1.2">
                <label class="cp-toggle" title="Afficher / masquer personator-v1.2">
                    <input
                        type="checkbox"
                        class="cp-checkbox"
                        data-project="personator-v1.2"
                        checked
                        onchange="cpToggleProject('personator-v1.2', this.closest('.cp-project-row'))"
                    >
                    <span class="cp-toggle-slider"></span>
                </label>
                <span class="cp-project-name" id="cp-label-personator-v1.2" onclick="cpToggleProject('personator-v1.2', this.closest('.cp-project-row'))">
                    personator-v1.2                </span>
                <select class="cp-size-select" data-project-size="personator-v1.2" title="Choisir le nombre de colonnes">
                                            <option value="4" >4 col</option>
                                            <option value="5" >5 col</option>
                                            <option value="6" >6 col</option>
                                            <option value="7" >7 col</option>
                ...
                <div class="cp-move-group">
                    <button type="button" class="cp-move-btn" onclick="cpMoveProject('personator-v1.2', -1)" title="Monter l'article">▲</button>
                    <button type="button" class="cp-move-btn" onclick="cpMoveProject('personator-v1.2', 1)" title="Descendre l'article">▼</button>
                </div>
            </div>
                        <div class="cp-project-row" data-cp-row="cms-2026-v8-full">
                <label class="cp-toggle" title="Afficher / masquer cms-2026-v8-full">
                    <input
                        type="checkbox"
                        class="cp-checkbox"
                        data-project="cms-2026-v8-full"
                        checked
                        onchange="cpToggleProject('cms-2026-v8-full', this.closest('.cp-project-row'))"
                    >
                    <span class="cp-toggle-slider"></span>
                </label>
                <span class="cp-project-name" id="cp-label-cms-2026-v8-full" onclick="cpToggleProject('cms-2026-v8-full', this.closest('.cp-project-row'))">
                    cms-2026-v8-full                </span>
                <select class="cp-size-select" data-project-size="cms-2026-v8-full" title="Choisir le nombre de colonnes">
                                            <option value="4" >4 col</option>
                                            <option value="5" >5 col</option>
                                            <option value="6" selected>6 col</option>
                                            <option value="7" >7 col</option>
                ...
                <div class="cp-move-group">
                    <button type="button" class="cp-move-btn" onclick="cpMoveProject('cms-2026-v8-full', -1)" title="Monter l'article">▲</button>
                    <button type="button" class="cp-move-btn" onclick="cpMoveProject('cms-2026-v8-full', 1)" title="Descendre l'article">▼</button>
                </div>
            </div>
                        <div class="cp-project-row" data-cp-row="texturor">
                <label class="cp-toggle" title="Afficher / masquer texturor">
                    <input
                        type="checkbox"
                        class="cp-checkbox"
                        data-project="texturor"
                        checked
                        onchange="cpToggleProject('texturor', this.closest('.cp-project-row'))"
                    >
                    <span class="cp-toggle-slider"></span>
                </label>
                <span class="cp-project-name" id="cp-label-texturor" onclick="cpToggleProject('texturor', this.closest('.cp-project-row'))">
                    texturor                </span>
                <select class="cp-size-select" data-project-size="texturor" title="Choisir le nombre de colonnes">
                                            <option value="4" >4 col</option>
                                            <option value="5" >5 col</option>
                                            <option value="6" selected>6 col</option>
                                            <option value="7" >7 col</option>
                ...
                <div class="cp-move-group">
                    <button type="button" class="cp-move-btn" onclick="cpMoveProject('texturor', -1)" title="Monter l'article">▲</button>
                    <button type="button" class="cp-move-btn" onclick="cpMoveProject('texturor', 1)" title="Descendre l'article">▼</button>
                </div>
            </div>
                        <div class="cp-project-row" data-cp-row="user_journey-v1.0">
                <label class="cp-toggle" title="Afficher / masquer user_journey-v1.0">
                    <input
                        type="checkbox"
                        class="cp-checkbox"
                        data-project="user_journey-v1.0"
                        checked
                        onchange="cpToggleProject('user_journey-v1.0', this.closest('.cp-project-row'))"
                    >
                    <span class="cp-toggle-slider"></span>
                </label>
                <span class="cp-project-name" id="cp-label-user_journey-v1.0" onclick="cpToggleProject('user_journey-v1.0', this.closest('.cp-project-row'))">
                    user_journey-v1.0                </span>
                <select class="cp-size-select" data-project-size="user_journey-v1.0" title="Choisir le nombre de colonnes">
                                            <option value="4" >4 col</option>
                                            <option value="5" >5 col</option>
                                            <option value="6" selected>6 col</option>
                                            <option value="7" >7 col</option>
                ...
                <div class="cp-move-group">
                    <button type="button" class="cp-move-btn" onclick="cpMoveProject('user_journey-v1.0', -1)" title="Monter l'article">▲</button>
                    <button type="button" class="cp-move-btn" onclick="cpMoveProject('user_journey-v1.0', 1)" title="Descendre l'article">▼</button>
                </div>
            </div>
                        <div class="cp-project-row" data-cp-row="wordpress-portable">
                <label class="cp-toggle" title="Afficher / masquer wordpress-portable">
                    <input
                        type="checkbox"
                        class="cp-checkbox"
                        data-project="wordpress-portable"
                        checked
                        onchange="cpToggleProject('wordpress-portable', this.closest('.cp-project-row'))"
                    >
                    <span class="cp-toggle-slider"></span>
                </label>
                <span class="cp-project-name" id="cp-label-wordpress-portable" onclick="cpToggleProject('wordpress-portable', this.closest('.cp-project-row'))">
                    wordpress-portable                </span>
                <select class="cp-size-select" data-project-size="wordpress-portable" title="Choisir le nombre de colonnes">
                                            <option value="4" >4 col</option>
                                            <option value="5" >5 col</option>
                                            <option value="6" selected>6 col</option>
                                            <option value="7" >7 col</option>
                ...
                <div class="cp-move-group">
                    <button type="button" class="cp-move-btn" onclick="cpMoveProject('wordpress-portable', -1)" title="Monter l'article">▲</button>
                    <button type="button" class="cp-move-btn" onclick="cpMoveProject('wordpress-portable', 1)" title="Descendre l'article">▼</button>
                </div>
            </div>
                        <div class="cp-project-row" data-cp-row="mon-site">
                <label class="cp-toggle" title="Afficher / masquer mon-site">
                    <input
                        type="checkbox"
                        class="cp-checkbox"
                        data-project="mon-site"
                        checked
                        onchange="cpToggleProject('mon-site', this.closest('.cp-project-row'))"
                    >
                    <span class="cp-toggle-slider"></span>
                </label>
                <span class="cp-project-name" id="cp-label-mon-site" onclick="cpToggleProject('mon-site', this.closest('.cp-project-row'))">
                    mon-site                </span>
                <select class="cp-size-select" data-project-size="mon-site" title="Choisir le nombre de colonnes">
                                            <option value="4" >4 col</option>
                                            <option value="5" >5 col</option>
                                            <option value="6" selected>6 col</option>
                                            <option value="7" >7 col</option>
                ...
                <div class="cp-move-group">
                    <button type="button" class="cp-move-btn" onclick="cpMoveProject('mon-site', -1)" title="Monter l'article">▲</button>
                    <button type="button" class="cp-move-btn" onclick="cpMoveProject('mon-site', 1)" title="Descendre l'article">▼</button>
                </div>
            </div>
                        <div class="cp-project-row" data-cp-row="Projet-demo-pour-site-en-ligne">
                <label class="cp-toggle" title="Afficher / masquer Projet-demo-pour-site-en-ligne">
                    <input
                        type="checkbox"
                        class="cp-checkbox"
                        data-project="Projet-demo-pour-site-en-ligne"
                        checked
                        onchange="cpToggleProject('Projet-demo-pour-site-en-ligne', this.closest('.cp-project-row'))"
                    >
                    <span class="cp-toggle-slider"></span>
                </label>
                <span class="cp-project-name" id="cp-label-Projet-demo-pour-site-en-ligne" onclick="cpToggleProject('Projet-demo-pour-site-en-ligne', this.closest('.cp-project-row'))">
                    Projet-demo-pour-site-en-ligne                </span>
                <select class="cp-size-select" data-project-size="Projet-demo-pour-site-en-ligne" title="Choisir le nombre de colonnes">
                                            <option value="4" >4 col</option>
                                            <option value="5" >5 col</option>
                                            <option value="6" selected>6 col</option>
                                            <option value="7" >7 col</option>
                ...
                <div class="cp-move-group">
                    <button type="button" class="cp-move-btn" onclick="cpMoveProject('Projet-demo-pour-site-en-ligne', -1)" title="Monter l'article">▲</button>
                    <button type="button" class="cp-move-btn" onclick="cpMoveProject('Projet-demo-pour-site-en-ligne', 1)" title="Descendre l'article">▼</button>
                </div>
            </div>
                    </div>
